  ...
  function ($rootScope, $log, handlers, models, settings, ngWebsockets, utils) {
    ...
    var connect = function (
      ...
      var onopen = function () {
        ...
        // This method is used to initialize weechat >= 2.9
        var salt;
        var _initializeConnection29 = function (
          passwd,
          nonce,
          iterations,
          totp
        ...
        var _parseWeechatTimeFormat = function () {
          ...
          if (timeFormat.indexOf("%H") > -1 || timeFormat.indexOf("%k") > -1) {
            // 24h time detected
        ...
        _performHandshake()
          .then(
            ...
            function (message) {
              ...
              if (passwordMethod != "pbkdf2+sha512") {
                ...
                $rootScope.$digest(); // Have to do this otherwise change detection doesn't see the error.
                throw new Error(
                  "No supported password hash algorithm returned."
                );
              }
            }
          )
          .then(function () {
            if (weechatAssumedPre2_9) {
              ...
              return _askTotp(useTotp).then(function (totp) {
          ...
          .then(
            function (version) {
              ...
              fetchConfValue("weechat.look.buffer_time_format", function () {
